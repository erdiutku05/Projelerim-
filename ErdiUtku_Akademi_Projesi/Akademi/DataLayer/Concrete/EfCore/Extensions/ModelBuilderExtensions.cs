...
namespace DataLayer.Concrete.EfCore.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            {
                //Admin
                new User {FirstName="Erdi", LastName="Utku", UserName="erdiutku", NormalizedUserName="ERDIUTKU", Email="erdiutku@hotmail.com", NormalizedEmail="ERDIUTKU@HOTMAIL.COM", Gender="Erkek", DateOfBirth= new DateTime(2000,8,11), City="İstanbul",Phone = "5555555555",EmailConfirmed=true,ImageId = 5},
                //Students
